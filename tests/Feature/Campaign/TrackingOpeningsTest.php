...
test('should increment openings on the database if the campaign is tracking openings', function () {
...
test('should not increment openings on the database if the campaign is not tracking openings', function () {
