...
test('when saving we need to update campaign::create session to have all the data', function () {
...
test('it should have o view a list of email list', function () {
    EmailList::factory()->count(2)->create();

    get($this->route)->assertViewHas('emailLists', function ($value) {
...
test('it should have o view a list of templates', function () {
    Template::factory()->count(2)->create();

    get($this->route)->assertViewHas('templates', function ($value) {
        expect($value)->toHaveCount(2);
...
test('it should have o view a blank tab variable', function () {
    get($this->route)
        ->assertViewHas('tab', '');
});

test('it should have o view the form variable ser to _config', function () {
    get($this->route)
        ->assertViewHas('form', '_config');
});

test('it should have o view all the data in the session in the variable data', function () {
    EmailList::factory()->create();
    $template = Template::factory()->create();
