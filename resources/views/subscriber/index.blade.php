<x-layouts.app>
    <x-slot name="header">
        <h2>{{ __('Email List') }} > {{ $emailList->title }} > {{ __('Subscribers') }}</h2>
    </x-slot>
    ...
    <x-card class="space-y-4">
        ...
        <div class="flex justify-between">
            ...
            <x-form :action="route('subscribers.index', $emailList)" class="flex items-center w-3/5 space-x-4" x-data x-ref="form" flat>
